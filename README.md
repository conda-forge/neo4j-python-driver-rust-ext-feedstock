About neo4j-python-driver-rust-ext-feedstock
============================================
...
Documentation: https://neo4j.com/docs/api/python-driver/6.3/
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/neo4j-python-driver-rust-ext-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/neo4j-python-driver-rust-ext-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=24008&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/neo4j-python-driver-rust-ext-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_python3.14.____cp314" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add neo4j-python-driver-rust-ext
# for installing globally
pixi global install neo4j-python-driver-rust-ext
```
...
It is possible to list all of the versions of `neo4j-python-driver-rust-ext` available on your platform:
...
```
pixi search neo4j-python-driver-rust-ext --channel conda-forge
```
